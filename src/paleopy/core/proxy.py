...
class proxy:
    ...
    period : string
            ...
            given dataset. Default is "1972-2020"
            user-defined
    ...
    qualitative=0, period="1972-2020", climatology="1981-2010", \
    ...
    def calculate_season(self):
        ...
        ts_seas.loc[:,'anomalies'] = ts_seas - ts_seas.loc[start_clim:end_clim].mean(0)
